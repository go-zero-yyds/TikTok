...
type Message struct {
	...
	CreateTime *int64 `protobuf:"varint,5,opt,name=CreateTime,proto3,oneof" json:"CreateTime,omitempty"` // 消息创建时间
}
...
var file_social_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x0a,

...
func (m *defaultMessageModel) Insert(ctx context.Context, data *Message) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.FromUserId, data.ToUserId, data.Content, data.CreatedTime)
	return ret, err
}
...
func (m *defaultMessageModel) Update(ctx context.Context, data *Message) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.FromUserId, data.ToUserId, data.Content, data.CreatedTime, data.Id)
	return err
}
